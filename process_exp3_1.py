...
def light_track(pose_estimator,
    ...
    if flag_visualize is True:
        ...
        show_validKeypoint_withID_from_standard_json(output_json_path, classes, joint_pairs, joint_names, image_folder, visualize_folder, flag_track = True)
...
if __name__ == '__main__':
    ...
    if args.dataset_split == "posetrack18_val":
        ...
        output_json_folder = "data/Data_2018/posetrack_results/lighttrack/results_exp3_1_openSVAI"
    ...
    visualize_folder = "data/Data_2018/posetrack_results/lighttrack/visualize_exp3_1/"
    output_video_folder = "data/Data_2018/videos_exp3_1/"
